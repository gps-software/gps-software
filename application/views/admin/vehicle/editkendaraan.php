                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form action="<?= site_url('dashboard/edit_kendaraan/' . $kendaraan['id']); ?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="plat_no" class="form-control" value="<?= $kendaraan['plat_no']; ?>" required>
                                        </div>
                                        <div class="form-group">
                                            <label>Warna</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="imei_gps" class="form-control" value="<?= $kendaraan['imei_gps']; ?>">
                                        </div>
                                        <div class="form-group">
                                            <label>Gambar</label>
                                            <input type="file" name="image" class="form-control">
                                            <?php if ($kendaraan['image']): ?>
                                                <img src="<?= base_url('assets/img/kendaraan/' . $kendaraan['image']); ?>" width="100" class="mt-2">
                                            <?php endif; ?>
                                        </div>
                                        <div class="form-group">
                                            <label>Status</label>
